...
class ConnectorSftp(models.AbstractModel):
...
class ConnectorSftpFile(models.AbstractModel):
    _name = 'connector.sftp.file'

    datas = fields.Binary(attachment=True)
    datas_fname = fields.Char('File name')
    date_fetch = fields.Datetime('Fetched on')
    import_state = fields.Selection([('to_import', 'To Import'),
                                     ('imported', 'Imported'),
                                     ('cancel', 'Cancelled'),
                                     ('fail', 'Failed'),
                                     ], default='to_import', required=True)
